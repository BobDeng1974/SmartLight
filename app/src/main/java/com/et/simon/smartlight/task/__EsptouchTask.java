package com.et.simon.smartlight.task;
...
import com.et.simon.smartlight.udp.UDPSocketClient;
import com.et.simon.smartlight.udp.UDPSocketServer;
import com.et.simon.smartlight.utils.ByteUtil;
import com.et.simon.smartlight.utils.EspNetUtil;
import com.et.simon.smartlight.utils.EsptouchGenerator;
import com.et.simon.smartlight.utils.EsptouchResult;
	...
	private void __listenAsyn(final int expectDataLen) {
		mTask = new Thread() {
			public void run() {
				...
				if (__IEsptouchTask.DEBUG) {
					Log.i(TAG, "期望的数据: " + (0 + expectOneByte));
				}
